...
\paragraph{Reference to related derivations.}
For additional derivations and context closely related to the constructions above, see Appendix C.1 (pp.~56--57) of \textit{Worldvolume Hybrid Monte Carlo algorithm for group manifolds}. A local copy is available at
\texttt{templates/son/Worldvolume Hybrid Monte Carlo algorithm for group manifolds.pdf}.
